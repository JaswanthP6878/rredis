...
use crate::{parse::{Parse, ParseError}, frame::Frame};
use bytes::Bytes;
...
impl Set {
    ...
    pub(crate) fn parse_frames(parse: &mut Parse) -> Result<Set> {
        ...
        match parse.next_string() {
            ...
            Ok(_) => return Err(anyhow!("currently `SET` only supports the expiration option")),
